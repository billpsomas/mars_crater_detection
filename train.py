...
parser.add_argument('--model_name', type=str, default='yolov8m.pt', help='Model name or path')
...
parser.add_argument('--device', nargs='+', type=int, default=[3], help='Device IDs of GPUs to use')
parser.add_argument('--batch', type=int, default=256, help='Batch size')
parser.add_argument('--data', type=str, default='data/mars.yaml', help='Path to dataset')
parser.add_argument('--name', type=str, default='yolov8m-mars-256', help='Name for the training session')
